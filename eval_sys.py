...
def get_fingerprints(smiles_list: t.List[str],
    ...
    def reduce_fn(row_col_1, row_col_2):
        row_1, col_1 = row_col_1
        row_2, col_2 = row_col_2
        row, col = (np.concatenate((row_1, row_2)),
                    np.concatenate((col_1, col_2)))
        return row, col
    ...
    row, col = reduce(reduce_fn, mapper(map_fn, enumerate(smiles_list)))
